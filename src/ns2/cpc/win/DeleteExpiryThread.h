...
*
*/
#ifndef __DELETEEXPIRYTHREAD__H
#define __DELETEEXPIRYTHREAD__H
...
extern int CheckDeleteRouteLifetime(IN_ADDR *pDestIPAddr);

#endif // __DELETEEXPIRYTHREAD__H
